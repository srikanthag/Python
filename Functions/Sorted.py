...
print(dict(sorted(d.items(), key=lambda item: len(item[0]))))   # sort a dictionary both key and value
...
temperatures = [('delhi', 32), ('Mumbai', 27), ('Kolkatha', 30), ('Chennai', 35)]
print(sorted(temperatures, key=lambda item: item[-1]))

# 11. wap to get most repeated word
sentence = 'hi hi how are you you'
s = sentence.split()
...
sentence = 'hi hi howfdd are you you'
s = sentence.split()
...
sentence = 'hi python python language programming programming hi howdah are you you'
s = sentence.split()
