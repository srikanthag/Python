...
# 4. wap to create a list using the following list if the word is of even length store the word as it is if it odd length
...
# 5. wap to create a list from the list if elements are type string keep the as it is else reverse it
...
# 7. wap to print integers present in the list
# l = ['python', 10, 3.2, 'selenium', 'java']
# l1 = [item for item in l if isinstance(item, int)]
# print(l1)

# 8. print all numeric datatypes by using isinstance
# l = ['python', 10, 3.2, 'selenium', 1+5j, True, 'java']
# l1 = [item for item in l if isinstance(item, (int, float, complex))]
# print(l1)

# 9. wap to print length of each string in the list
# l = ['python', 'selenium', 'java']
# l1 = [len(item) for item in l]
# print(l1)

# 10. wap to print the strings which are of even length in the list
# l = ['python', 'selenium', 'True', 'java', 'sri', 'for']
# l1 = [item for item in l if len(item) % 2 == 0]
# print(l1)

# 11. wap to print the strings which are of odd length in the list
# l = ['python', 'selenium', 'True', 'java', 'sri', 'for']
# l1 = [item for item in l if len(item) % 2 != 0]
# print(l1)

# 12. wap to print the elements in the list if the element is of even length print as it is, if it is odd then
# reverse and print
# l = ['python', 'selenium', 'True', 'java', 'sri', 'for']
# l1 = [item if len(item) % 2 == 0 else item[::-1] for item in l]
# print(l1)
...
# 15. wap print all the file name in the followig list
# l = ['youtube.txt', 'amazon.pdf', 'apple.xls', 'flipcart.in']
